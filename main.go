...
func main() {
	...
	*/
	...
	if len(slice) != 3 {
		panic("Ошибка: неправильный ввод, использовано больше 2-х чисел, попытка получения отрицательного числа в римской системе, либо использован неправильный оператор")
